...
class Program
{
    ...
    {
        Console.WriteLine("NT Service Installer - Direct Syscalls Implementation");
        Console.WriteLine("======================================================");
        Console.WriteLine();
        Console.WriteLine("Uses direct ntdll.dll calls to bypass user-mode API hooks");
        Console.WriteLine();
        Console.WriteLine("USAGE:");
        Console.WriteLine("  NtServiceInstaller.exe <command> [arguments]");
        Console.WriteLine();
        ...
        Console.WriteLine("  NtServiceInstaller.exe install \"C:\\MyApp\\app.exe\" MyService \"My App\" \"Description\"");
        Console.WriteLine("  NtServiceInstaller.exe start MyService");
        Console.WriteLine("  NtServiceInstaller.exe status MyService");
        Console.WriteLine("  NtServiceInstaller.exe stop MyService");
        Console.WriteLine("  NtServiceInstaller.exe uninstall MyService");
        Console.WriteLine();
        Console.WriteLine("NOTE:");
        Console.WriteLine("  - This program must be run as Administrator");
        Console.WriteLine("  - Uses NT API to bypass advapi32.dll hooks");
        Console.WriteLine("  - Service may require reboot or SCM refresh to appear");
        Console.WriteLine();
        Console.WriteLine("OPSEC:");
        Console.WriteLine("  - No CreateService/OpenSCManager calls");
        Console.WriteLine("  - Direct ntdll.dll registry manipulation");
        Console.WriteLine("  - Bypasses user-mode API hooks");
    }
